...
// @brief -> Responsável por gerar substrings e organizá-las em ordem alfabética.

// @param -> Recebe e guarda uma string na variável "palavra". A partir desta string serão cridas 
// substrings as quais serão transformadas em um vetor do tipo char, organizadas em ordem alfabética e armazenadas em um ArrayList.

// @returt -> O algoritmo retornará um ArrayList contendo as substrings geradas.
...
// @brief -> Responsável por contar a quantidade de anagramas pares dentro do ArrayList.

// @param -> Recebe um ArrayList contendo as substrings de uma palavra. O algoritmo contará os anagramas pares e armazenará
// a quantidade na variável contador.

// @returt -> O algoritmo retornará a quantidade máxima de anagramas pares.
